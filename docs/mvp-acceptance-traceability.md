...
| AC-EFFICIENCY | 効率: 人手修正時間の削減を測定し効果を確認（30%+目安） | [#284](https://github.com/TommyKammy/VeriDoc/issues/284), [#285](https://github.com/TommyKammy/VeriDoc/issues/285), [#289](https://github.com/TommyKammy/VeriDoc/issues/289), [#308](https://github.com/TommyKammy/VeriDoc/issues/308), [#319](https://github.com/TommyKammy/VeriDoc/issues/319) | `docs/mvp-human-review-protocol.md`, `docs/mvp-human-review-evidence.schema.json`, and `scripts/ci/validate_mvp_human_review_evidence.py`; current gap: real participant comparison | **未達** — the approved baseline task/gold revisions, cohort, training, timing and hidden-gold boundary, paired calculation, independent quality approval, privacy boundary, and rejection conditions now have a versioned protocol and validator-backed schema, but no completed human record or 30%+ result exists. |
...
| --- | --- | --- | --- | --- |
| EM-USER-REVIEW | 実務担当者によるレビュー試行（時間・見逃し・過検出） | [#283](https://github.com/TommyKammy/VeriDoc/issues/283), [#284](https://github.com/TommyKammy/VeriDoc/issues/284), [#289](https://github.com/TommyKammy/VeriDoc/issues/289), [#308](https://github.com/TommyKammy/VeriDoc/issues/308), [#319](https://github.com/TommyKammy/VeriDoc/issues/319) | `docs/mvp-human-review-protocol.md`, `docs/mvp-human-review-execution-checklist.md`, and validator-backed valid/invalid examples | **未達** — the execution protocol records correction time, hidden-gold attestation, high-risk misses, over-detection, completion/blocker, retries, exclusions, and total/per-arm metrics under pseudonymous IDs, but no real participant user-review record exists. |
