...
| AC-EFFICIENCY | 効率: 人手修正時間の削減を測定し効果を確認（30%+目安） | [#284](https://github.com/TommyKammy/VeriDoc/issues/284), [#285](https://github.com/TommyKammy/VeriDoc/issues/285), [#289](https://github.com/TommyKammy/VeriDoc/issues/289), [#308](https://github.com/TommyKammy/VeriDoc/issues/308), [#319](https://github.com/TommyKammy/VeriDoc/issues/319) | `docs/mvp-human-review-protocol.md`, `docs/mvp-human-review-evidence.schema.json`, and `scripts/ci/validate_mvp_human_review_evidence.py`; current gaps: renewed structured-target approval and real participant comparison | **未達** — the protocol pins the approved product commit/tree, manifest contract, source fixtures, per-run build provenance, strict timestamps, sealed artifact digests, opaque identifiers, hidden-gold boundary, and paired calculation. The approved `p12g-02-v1` manifest predates structured high-risk targets, so the validator keeps `efficiency_target_met` false until a new decision revision approves those targets; no completed human record exists either. |
...
| --- | --- | --- | --- | --- |
| EM-USER-REVIEW | 実務担当者によるレビュー試行（時間・見逃し・過検出） | [#283](https://github.com/TommyKammy/VeriDoc/issues/283), [#284](https://github.com/TommyKammy/VeriDoc/issues/284), [#289](https://github.com/TommyKammy/VeriDoc/issues/289), [#308](https://github.com/TommyKammy/VeriDoc/issues/308), [#319](https://github.com/TommyKammy/VeriDoc/issues/319) | `docs/mvp-human-review-protocol.md`, `docs/mvp-human-review-execution-checklist.md`, and validator-backed valid/invalid examples | **未達** — the execution protocol records correction time, hidden-gold attestation, approved source/build provenance, unique sealed-artifact identities and digests, misses, over-detection, completion/blocker, retries, exclusions, and total/per-arm metrics under generated opaque IDs. A renewed structured-target decision and real participant record remain absent. |
