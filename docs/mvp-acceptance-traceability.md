...
| AC-REVIEW | レビュー: 高リスク項目の自動確定ゼロ・見逃し率0 | [#278](https://github.com/TommyKammy/VeriDoc/issues/278), [#284](https://github.com/TommyKammy/VeriDoc/issues/284), [#289](https://github.com/TommyKammy/VeriDoc/issues/289) | `tests/test_automatic_validation.py`, `tests/test_evaluate_dataset.py`; final evidence: representative high-risk gate output with zero misses | **一部達成** — existing validation evidence does not replace the Phase12 cross-boundary guarantee and representative result. |
...
| --- | --- | --- | --- | --- |
| FC-HIGH-RISK | 高リスク項目が自動確定される、または要確認に乗らない | [#278](https://github.com/TommyKammy/VeriDoc/issues/278), [#289](https://github.com/TommyKammy/VeriDoc/issues/289) | `tests/test_automatic_validation.py`, `tests/test_evaluate_dataset.py` | **一部達成** — #278 must prove the real cross-boundary path remains review-required; any miss blocks the gate. |
