...
items with `overall_decision=fail`, and its five-case harness contains two
`fail`, zero `unknown`, and three `pass` results.
...
| AC-SECURITY | セキュリティ: 外部送信なし | [#281](https://github.com/TommyKammy/VeriDoc/issues/281), [#288](https://github.com/TommyKammy/VeriDoc/issues/288), [#289](https://github.com/TommyKammy/VeriDoc/issues/289), [#317](https://github.com/TommyKammy/VeriDoc/issues/317) | `scripts/ci/mvp_browser_e2e.py`, `tests/test_mvp_browser_e2e.py`, `artifacts/mvp-browser-e2e/<run-id>/evidence.json` | **達成** — the acceptance run observes browser HTTP plus harness DNS/socket attempts, permits only the explicit loopback origin, and records `external_ai_api_send_count=0`; external endpoint configuration or an external attempt fails closed. |
...
| FC-EXTERNAL-SEND | 外部送信が発生する | [#281](https://github.com/TommyKammy/VeriDoc/issues/281), [#289](https://github.com/TommyKammy/VeriDoc/issues/289), [#317](https://github.com/TommyKammy/VeriDoc/issues/317) | `scripts/ci/mvp_browser_e2e.py`, `tests/test_mvp_browser_e2e.py`, `artifacts/mvp-browser-e2e/<run-id>/evidence.json` | **達成** — external HTTP, DNS, socket, and configured endpoint negative cases are rejected before they can be accepted as local-only evidence. |
...
| FC-REPRODUCIBILITY | 同一条件の再現性が説明できない | [#282](https://github.com/TommyKammy/VeriDoc/issues/282), [#283](https://github.com/TommyKammy/VeriDoc/issues/283), [#284](https://github.com/TommyKammy/VeriDoc/issues/284), [#317](https://github.com/TommyKammy/VeriDoc/issues/317) | `scripts/ci/mvp_browser_e2e.py`, `tests/test_mvp_browser_e2e.py`, `artifacts/mvp-browser-e2e/<run-id>/rerun-package.json` | **達成** — a sealed package pins commit, manifest/fixtures, config, dependencies, model/prompt/schema versions, and commands; rerun rejects drift and compares decision-relevant output while excluding declared nondeterministic fields. |
...
| EM-E2E | 代表テンプレートでのE2E評価 | [#283](https://github.com/TommyKammy/VeriDoc/issues/283), [#284](https://github.com/TommyKammy/VeriDoc/issues/284), [#289](https://github.com/TommyKammy/VeriDoc/issues/289), [#309](https://github.com/TommyKammy/VeriDoc/issues/309) | Versioned five-case manifest and current report plus `artifacts/mvp-browser-e2e/<run-id>/evidence.json`; current gap: P12G-05 through P12G-12 | **一部達成** — one repo-owned browser run packages screenshots, trace, API result, downloaded artifact, audit artifact, and correlation metadata; the dataset/harness/report chain has two `fail`, zero `unknown`, and three `pass`, with Word, Excel, and record PDF evidence present. |
