...
| AC-TEMPLATE | テンプレート: 代表3〜5種で変換が成立 | [#283](https://github.com/TommyKammy/VeriDoc/issues/283), [#284](https://github.com/TommyKammy/VeriDoc/issues/284), [#308](https://github.com/TommyKammy/VeriDoc/issues/308), [#312](https://github.com/TommyKammy/VeriDoc/issues/312) | `datasets/mvp_evaluation_manifest_v1.json`, `docs/mvp-scope-decisions.md`, `tests/test_dataset_fixtures.py`, current five-case report; current gap: P12G-12 accepted-scope rollup | **一部達成** — decision revision `p12g-02-v1` adopts the five-category manifest as the representative MVP scope and all five cases pass. The scanned case passes only as an explicit fail-closed OCR boundary with no fabricated text; the final accepted-scope rollup remains open. |
| AC-QUALITY | 品質: 主要帳票でセル一致率80%+の目安 | [#283](https://github.com/TommyKammy/VeriDoc/issues/283), [#284](https://github.com/TommyKammy/VeriDoc/issues/284), [#289](https://github.com/TommyKammy/VeriDoc/issues/289), [#312](https://github.com/TommyKammy/VeriDoc/issues/312) | `tests/test_evaluate_dataset.py`, current five-case report; current gap: P12G-12 | **未達** — all five cases pass artifact/review/audit evaluation, but no current per-template 80%+ rollup exists. The scanned pass contributes explicit-block and source-link metrics rather than an OCR text-accuracy claim. |
