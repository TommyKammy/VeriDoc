...
| --- | --- | --- | --- | --- |
| AC-UI | UI: 投入→設定→ジョブ→プレビュー→レビュー→DLが通る | [#245](https://github.com/TommyKammy/VeriDoc/issues/245), [#247](https://github.com/TommyKammy/VeriDoc/issues/247), [#249](https://github.com/TommyKammy/VeriDoc/issues/249), [#259](https://github.com/TommyKammy/VeriDoc/issues/259), [#260](https://github.com/TommyKammy/VeriDoc/issues/260), [#284](https://github.com/TommyKammy/VeriDoc/issues/284), [#309](https://github.com/TommyKammy/VeriDoc/issues/309) | `tests/test_mvp_browser_e2e.py`, `scripts/ci/mvp_browser_e2e.py`, `artifacts/mvp-browser-e2e/<run-id>/evidence.json`; current gap: P12G-08 keyboard/high-risk breadth | **一部達成** — one repo-owned Playwright run binds upload, settings recovery, job, preview, approval, primary download hash, audit artifact, screenshots, and trace to one correlation ID; the complete keyboard/high-risk matrix remains open. |
