...
| AC-EFFICIENCY | 効率: 人手修正時間の削減を測定し効果を確認（30%+目安） | [#284](https://github.com/TommyKammy/VeriDoc/issues/284), [#285](https://github.com/TommyKammy/VeriDoc/issues/285), [#289](https://github.com/TommyKammy/VeriDoc/issues/289), [#308](https://github.com/TommyKammy/VeriDoc/issues/308), [#319](https://github.com/TommyKammy/VeriDoc/issues/319) | `docs/mvp-human-review-protocol.md`, `docs/mvp-human-review-practice-package.json`, `docs/mvp-human-review-evidence.schema.json`, and `scripts/ci/validate_mvp_human_review_evidence.py`; current gaps: authenticated execution attestation, renewed structured-target approval, and real participant comparison | **未達** — the protocol pins the approved product commit/tree, manifest contract, source fixtures, strict timestamps, per-participant consent attestations, an immutable per-arm practice package, independently generated UUIDv4 participant IDs, one shared checklist revision, sealed artifact digests, an honestly retained hidden-gold boundary, and paired calculation. Its current per-run provenance binds only an approved source-tree listing and explicitly marks execution `unverified_validation_only`; completed-study pairs therefore remain ineligible and no median is claimed. The approved `p12g-02-v1` manifest also predates structured high-risk targets, and no completed human record exists. |
...
| --- | --- | --- | --- | --- |
| EM-USER-REVIEW | 実務担当者によるレビュー試行（時間・見逃し・過検出） | [#283](https://github.com/TommyKammy/VeriDoc/issues/283), [#284](https://github.com/TommyKammy/VeriDoc/issues/284), [#289](https://github.com/TommyKammy/VeriDoc/issues/289), [#308](https://github.com/TommyKammy/VeriDoc/issues/308), [#319](https://github.com/TommyKammy/VeriDoc/issues/319) | `docs/mvp-human-review-protocol.md`, `docs/mvp-human-review-practice-package.json`, `docs/mvp-human-review-execution-checklist.md`, and validator-backed valid/invalid examples | **未達** — the execution protocol records privacy-safe participant consent, immutable practice-package use per arm, correction time, honestly retained hidden-gold violations, approved source-tree provenance, explicit execution-attestation status, one shared checklist revision, unique sealed-artifact identities and digests, misses, over-detection, completion/blocker, retries, exclusions, and total/per-arm metrics under independently generated UUIDv4 participant IDs. Authenticated execution evidence, a renewed structured-target decision, and a real participant record remain absent. |
