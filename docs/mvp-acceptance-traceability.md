...
| AC-EFFICIENCY | 効率: 人手修正時間の削減を測定し効果を確認（30%+目安） | [#284](https://github.com/TommyKammy/VeriDoc/issues/284), [#285](https://github.com/TommyKammy/VeriDoc/issues/285), [#289](https://github.com/TommyKammy/VeriDoc/issues/289), [#308](https://github.com/TommyKammy/VeriDoc/issues/308), [#319](https://github.com/TommyKammy/VeriDoc/issues/319) | `docs/mvp-human-review-protocol.md`, `docs/mvp-human-review-practice-package.json`, `datasets/mvp_human_review_gold_package_v1.json`, `docs/mvp-human-review-evidence.schema.json`, and `scripts/ci/validate_mvp_human_review_evidence.py`; current gaps: authenticated execution attestation, renewed structured-target approval, and real participant comparison | **未達** — the protocol pins the approved product commit/tree, manifest source fixtures and target formats, privacy-safe opaque approval references, immutable practice and per-case gold package digests, strict timestamps, independently generated UUIDv4 participant IDs, one checklist revision, sealed artifact digests, a hidden-gold boundary, and paired calculation. Completed records retain calculable pair measurements, but current provenance remains `unverified_validation_only`, so those pairs are ineligible and no median is claimed. The pinned structured scoring content is explicitly `unapproved_validation_only`; the approved `p12g-02-v1` manifest predates it, and no completed human record exists. |
...
| --- | --- | --- | --- | --- |
| EM-USER-REVIEW | 実務担当者によるレビュー試行（時間・見逃し・過検出） | [#283](https://github.com/TommyKammy/VeriDoc/issues/283), [#284](https://github.com/TommyKammy/VeriDoc/issues/284), [#289](https://github.com/TommyKammy/VeriDoc/issues/289), [#308](https://github.com/TommyKammy/VeriDoc/issues/308), [#319](https://github.com/TommyKammy/VeriDoc/issues/319) | `docs/mvp-human-review-protocol.md`, `docs/mvp-human-review-practice-package.json`, `datasets/mvp_human_review_gold_package_v1.json`, `docs/mvp-human-review-execution-checklist.md`, and validator-backed valid/invalid examples | **未達** — the execution protocol records opaque consent/quality references, immutable practice-package use per arm, manifest-bound target formats, per-case gold digests, correction time even for calculable ineligible pairs, hidden-gold violations, source-tree provenance, execution-attestation status, checklist and sealed-artifact identities, misses, over-detection, blockers, retries, exclusions, and total/per-arm metrics under independently generated UUIDv4 participant IDs. Authenticated execution evidence, renewed structured-target approval, and a real participant record remain absent. |
