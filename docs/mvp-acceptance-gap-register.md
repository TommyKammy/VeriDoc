...
- Criteria source Git blob:
  `facd399c34b88578415ac74a572055c8f8dca4d6`
- Evaluator Git blob:
...
| EM-E2E | 一部達成 / fail | A repo-owned browser run emits screenshots, trace, API result, downloaded artifact, audit artifact, and correlation metadata for one representative case; the versioned five-case report is three `fail`, zero `unknown`, and two `pass`, with persisted review decisions for Word and Excel. | `implementation_gap`, `e2e_gap` | codex/hybrid | P12G-05 through P12G-12 evidence from one committed snapshot with all intended cases passing. | P12G-05–P12G-12 |
