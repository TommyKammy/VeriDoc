...
- Criteria source Git blob:
  `3551200668b7c0e3d3ed0e2ffa486113db73a1a3`
- Evaluator Git blob:
...
| EM-USER-REVIEW | 未達 / fail | The versioned protocol, closed privacy-safe schema, synthetic valid/invalid examples, and P12G-14 checklist bind each generated run ID and source-fixture hash to the approved manifest contract while defining correction time, hidden-gold, miss, over-detection, completion/blocker, retry, exclusion, and total/per-arm evidence. Renewed structured-target approval and a real reviewer record remain absent. | `human_evidence_gap` | manual | Approve the structured targets, then execute `docs/mvp-human-review-execution-checklist.md` and retain a validator-passing completed record. | P12G-14 |
...
| P12G-13 | hybrid | P12G-02 | `p12g-13-human-review-v1`, its strict duplicate-key-rejecting privacy-safe schema/validator, approved manifest/fixture pins, generated run IDs, synthetic validation vectors, and the P12G-14 execution checklist are fixed; structured-target reapproval and real participant execution remain manual. |
