...
- Criteria source Git blob:
  `79c363f5253f15337d7074ba6d05482b649c52f9`
- Evaluator Git blob:
...
| AC-EFFICIENCY | 未達 / fail | `docs/mvp-human-review-protocol.md` and its validator-backed schema bind the approved task/gold revisions, cohort, training, timing and hidden-gold boundary, paired median, independent quality approval, privacy boundary, and rejection conditions in `docs/mvp-scope-decisions.md` to `p12g-02-v1` and `phase12-mvp-v1`; no completed participant record or measured 30%+ human result exists. | `human_evidence_gap` | manual | Run the fixed protocol with a real pseudonymous cohort and retain a valid completed record. | P12G-14 |
...
| EM-USER-REVIEW | 未達 / fail | The versioned protocol, closed privacy-safe schema, synthetic valid/invalid examples, and P12G-14 checklist define correction time, hidden-gold attestation, miss, over-detection, completion/blocker, retry, exclusion, and total/per-arm evidence; no real participant reviewer record exists. | `human_evidence_gap` | manual | Execute `docs/mvp-human-review-execution-checklist.md` and retain a validator-passing completed record. | P12G-14 |
...
| P12G-13 | hybrid | P12G-02 | `p12g-13-human-review-v1`, its recomputable privacy-safe schema/validator, synthetic validation vectors, and the P12G-14 execution checklist are fixed; real participant execution remains manual. |
