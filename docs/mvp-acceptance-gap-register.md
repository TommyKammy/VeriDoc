...
- Criteria source Git blob:
  `5d9180a08adba42cd8ccc6a99c8d8dbbe80cadc9`
- Evaluator Git blob:
...
| AC-EFFICIENCY | 未達 / fail | `docs/mvp-human-review-protocol.md` and its validator-backed schema bind the task, cohort, training, timing boundary, paired median, privacy boundary, and rejection conditions approved in `docs/mvp-scope-decisions.md` to `p12g-02-v1` and `phase12-mvp-v1`; no completed participant record or measured 30%+ human result exists. | `human_evidence_gap` | manual | Run the fixed protocol with a real pseudonymous cohort and retain a valid completed record. | P12G-14 |
...
| EM-USER-REVIEW | 未達 / fail | The versioned protocol, closed privacy-safe schema, synthetic valid/invalid examples, and P12G-14 checklist define correction time, miss, over-detection, completion/blocker, retry, and exclusion evidence; no real participant reviewer record exists. | `human_evidence_gap` | manual | Execute `docs/mvp-human-review-execution-checklist.md` and retain a validator-passing completed record. | P12G-14 |
