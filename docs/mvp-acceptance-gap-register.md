...
- Criteria source Git blob:
  `39e1dd43cf14780d93954b83f5112642a0b0832f`
- Evaluator Git blob:
...
| EM-USER-REVIEW | 未達 / fail | The versioned protocol, closed privacy-safe schema, synthetic valid/invalid examples, and P12G-14 checklist bind each run to an independently generated UUIDv4 participant ID, the shared checklist revision, the approved source fixture/build, and a unique sealed-artifact record while defining strict timing, hidden-gold, miss, over-detection, completion/blocker, retry, exclusion, and total/per-arm evidence. Renewed structured-target approval and a real reviewer record remain absent. | `human_evidence_gap` | manual | Approve the structured targets, then execute `docs/mvp-human-review-execution-checklist.md` and retain a validator-passing completed record. | P12G-14 |
